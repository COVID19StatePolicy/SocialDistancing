...
Analysis of these data is also underway; interested parties should contact us (see contact information below).
...
| ------------- | ------------- | ------------- | ------------- | ------------- |
| Christopher Adolph  | Department of Political Science, University of Washington  | | | |
