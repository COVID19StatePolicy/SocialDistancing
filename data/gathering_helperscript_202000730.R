...
#Date: July 30, 2020
#Purpose: Helper script for new gathering restriction coding system
...
###################################################
#####(RE)CREATING PAST GATHERING LABELS############
##################################################

####New system to old system: adding numerical gathering limits to GathRestrict and "Any"
